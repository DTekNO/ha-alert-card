...
- `dist/ha-alert-card.js` — release output. **Never edit directly.** Generated by the release workflow.
...
- Do not commit a built `dist/` file manually; it is always overwritten by the release workflow.
